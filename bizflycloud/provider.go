...
func Provider() terraform.ResourceProvider {
	p := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"bizflycloud_simple_storage_bucket":            resourceBizflySimpleStoreBucket(),
			"bizflycloud_simple_storage_access_key":        resourceBizflySimpleStoreKey(),
			"bizflycloud_simple_store_acl":                 resourceBizflySimpleStoreAcl(),
			"bizflycloud_simple_store_versioning":          resourceBizflySimpleStoreVersioning(),
			"bizflycloud_simple_store_cors":                resourceBizflySimpleStoreCors(),
			"bizflycloud_simple_store_website_config":      resourceBizflySimpleStoreWebsiteConfig(),
