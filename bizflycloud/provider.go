...
func Provider() terraform.ResourceProvider {
	p := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"bizflycloud_cloud_database_node":                  resourceBizflyCloudCloudDatabaseNode(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"bizflycloud_cloud_database_backup_schedule":   datasourceBizflyCloudDatabaseBackupSchedule(),
